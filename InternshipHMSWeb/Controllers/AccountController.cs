...
namespace InternshipHMSWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void SignInResult(LoginViewModel model)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    HttpCookie objCookie = new HttpCookie("token");
                    objCookie.Value = model.token;
                    objCookie.Expires = DateTime.Now.AddDays(5);
                    //objCookie.Values["token"] = model.token;
                ...
                default:
                    ModelState.AddModelError("", "ایمیل یا رمز عبور اشتباه وارد شده است");
                    return View(model);
            }
        }
